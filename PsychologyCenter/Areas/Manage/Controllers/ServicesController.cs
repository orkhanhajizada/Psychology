...
namespace PsychologyCenter.Areas.Manage.Controllers
{
    ...
    public class ServicesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Text,Icon,OrderBy")] Service service)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Text,Icon,OrderBy")] Service service)
        {
            if (ModelState.IsValid)
            {
